# Generated by Powerlevel10k configuration wizard on 2020-02-16 at 03:19 CET.
...
() {
  ...
  if [[ ${langinfo[CODESET]:-} != (utf|UTF)(-|)8 ]]; then
    local LC_ALL=${${(@M)$(locale -a):#*.(utf|UTF)(-|)8}[1]:-fr_FR.UTF-8}
  fi

  # The list of segments shown on the left. Fill it with the most important segments.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    vi_mode                 # os identifier
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=242
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='%031F%254F%031F%f'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%168F%254F%168F%f'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_CONTENT_EXPANSION='%031F%254F%031F%f'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_CONTENT_EXPANSION='%168F%254F%168F%f'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_CONTENT_EXPANSION='%031F%254F%031F%f'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_CONTENT_EXPANSION='%168F%254F%168F%f'
  # Prompt symbol in overwrite vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIOWR_CONTENT_EXPANSION='%031F%254F%031F%f'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIOWR_CONTENT_EXPANSION='%168F%254F%168F%f'
  ...
  ##################################[ dir: current directory ]##################################
  # Path Separator. Default is none.
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%232F' # '%250F'  # grey foreground
      local      clean='%232F' # '%76F'   # green foreground
      local   modified='%232F' # '%178F'  # yellow foreground
      local  untracked='%232F' # '%39F'   # blue foreground
      local conflicted='%B%F{196}' # '%196F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%232F'  # grey foreground
      local      clean='%232F'  # grey foreground
      local   modified='%232F'  # grey foreground
      local  untracked='%232F'  # grey foreground
      local conflicted='%232F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=110
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=174
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=242
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_FOREGROUND=242
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=109
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING=''
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=242
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=173
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=''
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_FOREGROUND=254
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=242
  # Text and color for insert vi mode.
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING=''
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_FOREGROUND=254
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND=242
